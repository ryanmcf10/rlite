...
from initialize_new_game import get_constants
...
def main():
    ...
    fighter_component = create_fighter(FighterType.PLAYER)
    ...
    libtcod.console_init_root(screen_width, screen_height, 'rlite', False)
